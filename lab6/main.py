...
# обучаем классификатор на наборе данных
linear_svm = LinearSVC().fit(X, y)
print("Форма коэффициента: ", linear_svm.coef_.shape) # веткора
print("Форма константы: ", linear_svm.intercept_.shape) # одномерный массив
